...
firebase_admin.initialize_app(cred, {
    ...
    'storageBucket': "faceattendancerealtimerecog.appspot.com"
})
...
while True:
    ...
    if counter != 0:
        ...
        cv2.putText(imgBackground, str(studentInfo['year']), (1025, 625), cv2.FONT_HERSHEY_COMPLEX, 0.6,
                    (100, 100, 100), 2)
        cv2.putText(imgBackground, str(studentInfo['standing']), (1125, 625), cv2.FONT_HERSHEY_COMPLEX, 0.6,
                    (100, 100, 100), 2)
